...
class ScreenAnalysis:
    ...
    def analyze(self):
        screenshot_staging = Image.open(os.path.join('screenshots', 'screen_staging.png'))
        screenshot_production = Image.open(os.path.join('screenshots', 'screen_production.png'))
        columns = 60
        rows = 80
